...
{\textbf{\huge{ BÁO CÁO PROJECT 1}}}\\[1cm]
{\textbf{\Large{Phân loại chữ số viết tay trong dataset MNIST \\
bằng phương pháp SVM và CNN}}\\[1cm]

{\textbf{\large{PHẠM HOÀNG THÁI DƯƠNG}}}\\
{\large{duong.pht235061@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} & Cô Trần Thị Lan Anh \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]
