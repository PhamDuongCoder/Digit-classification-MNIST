...
\usepackage{tocbasic}
\usepackage{tabularx} % Gói lệnh để tự động căn chỉnh chiều rộng cột
...
\tocitem{\textbf{Chương 1: Giới thiệu đề tài}}{1}
\tocitem{\hspace{10pt} 1.1: Đặt vấn đề}{1}
\tocitem{\hspace{10pt} 1.2: Mục tiêu và định hướng giải pháp}{1}
\tocitem{\hspace{10pt} 1.3: Bố cục đồ án}{1}

\vspace{5pt}
\tocitem{\textbf{Chương 2: Cơ sở lý thuyết}}{2}
\tocitem{\hspace{10pt} 2.1: Support Vector Machine (SVM)}{2}
\tocitem{\hspace{10pt} 2.2: Convolutional Neural Network (CNN)}{5}

\vspace{5pt}
\tocitem{\textbf{Chương 3: Áp dụng vào bài toán thực tế}}{8}
\tocitem{\hspace{10pt} 3.1: Thực nghiệm với mô hình SVM}{8}
\tocitem{\hspace{10pt} 3.2: Thực nghiệm với mô hình CNN}{10}

\vspace{5pt}
\tocitem{\textbf{Chương 4: Kết quả thực nghiệm}}{13}
\tocitem{\hspace{10pt} 4.1: Kết quả thực nghiệm với mô hình SVM}{13}
\tocitem{\hspace{10pt} 4.2: Kết quả thực nghiệm với mô hình CNN}{14}

\vspace{5pt}
\tocitem{\textbf{Chương 5: Demo}}{16}
\tocitem{\hspace{10pt} 5.1: Huấn luyện mô hình}{16}
\tocitem{\hspace{10pt} 5.2: Kiểm tra mô hình}{16}

\vspace{5pt}
\tocitem{\textbf{Chương 6: Kết luận}}{17}
...
\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{ÁP DỤNG VÀO BÀI TOÁN THỰC TẾ}
\subfile{Chuong/3_Ap_dung.tex}
